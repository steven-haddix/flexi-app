...
const equipmentUpdateSchema = z.object({
    equipment: z.array(z.string()).describe("The complete updated list of gym equipment"),
});
...
export async function POST(
    ...
    try {
        ...
        const result = await generateText({
            ...
            system: "You are a gym equipment specialist. Your task is to update a list of gym equipment based on a user's natural language prompt. You will be given the current equipment list and an instruction of what to add or remove. Return the FULL updated list of equipment. Be concise with equipment names.",
            prompt: `
