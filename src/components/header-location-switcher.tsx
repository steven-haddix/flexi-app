                ...
                >
                    <MapPin
                        className={cn(
                            ...
                            currentLocation ? "opacity-100 text-foreground" : "opacity-70",
                        )}
                    />
                    {currentLocation && (
                    ...
                    {locations.map((location) => (
                        <div
                            ...
                            onClick={() => {
                                ...
                                savePreferences({ selectedGymId: location.id });
                                posthog.capture("location_switched", {
                            ...
                            <div className="flex items-center gap-0.5">
                                ...
                                <ConfirmDialog
                                    ...
                                    onConfirm={() => {
                                        ...
                                        // If we deleted the current one, we should probably update preferences to null,
                                        // but setCurrentLocation(null) handles the UI.
                                        // We can sync that too.
                                        if (currentLocationId === location.id) {
                                            setCurrentLocation(null);
                                            savePreferences({ selectedGymId: null });
                                        }
...
function CustomAddLocationDialog({
    onOpenChange,
}: {
