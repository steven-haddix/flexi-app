...
import { Loader2, Sparkles, Trash2, Calendar, ChevronDown, ChevronUp } from "lucide-react";
...
export function WorkoutView() {
    ...
    if (!currentLocation) {
        return (
            <div className="text-center py-12 border-2 border-dashed rounded-xl opacity-50 bg-muted/20">
                <p className="text-muted-foreground font-medium">Select a gym above to start</p>
            </div>
        );
    }
            ...
            <div className="flex items-center justify-between px-1">
                ...
                <Dialog open={isOpen} onOpenChange={setIsOpen}>
                    <DialogTrigger asChild>
                        <Button size="sm" className="rounded-full shadow-lg transition-all hover:scale-105 active:scale-95">
                ...
                {filteredWorkouts.length === 0 ? (
                    ...
                    <div className="grid gap-4">
                        {filteredWorkouts.map((workout) => {
                            ...
                            return (
                                <Card key={workout.id} className="overflow-hidden border-2 hover:border-primary/20 transition-colors">
                                    <CardHeader
                                                ...
                                                <div className="space-y-0.5 min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {workout.status === "draft" && (
                                                            <Badge variant="secondary" className="bg-amber-100/50 text-amber-700 hover:bg-amber-100/50 border-amber-200/50 text-[10px] h-4 px-1">
                                                                Draft
                                                            </Badge>
                                                        )}
                                                    </div>
